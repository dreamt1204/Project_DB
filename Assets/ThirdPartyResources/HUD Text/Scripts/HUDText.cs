...
public class HUDText : MonoBehaviour
{
	...
	/// <summary>
	/// Add a new scrolling text entry. If it's numeric, it will be unsigned.
	/// </summary>

	public void AddUnsigned (object obj, Color c, float stayDuration)
	{
		if (!enabled) return;
		...
		if (isNumeric) ne.label.text = Mathf.RoundToInt(ne.val).ToString();
		else ne.label.text = obj.ToString();
